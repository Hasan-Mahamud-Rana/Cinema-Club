        ...
        <div class="saveKupon">
          ...
          <div class="row columns">
            <div class="small-12 medium-10 medium-centered large-10 large-centered columns">
              ...
              <form action="<?php echo site_url(); ?>/gem-papirmedlemskab/save/" method="POST" data-parsley-validate data-parsley-focus="none">
                <?php } if ( is_bkdk_user_logged_in() != true && ($customerid == NULL || $customerid  == ' ') ) { ?>
                <form action="<?php echo site_url(); ?>/gem-papirmedlemskab/login/" method="POST" data-parsley-validate data-parsley-focus="none">
                  <?php } ?>
                  <input type="text" name="code" data-parsley-minlength="9" data-parsley-minlength-message="Indtast gyldigt ordrenummer" data-parsley-required-message="Indtast gyldigt ordrenummer" placeholder="Indtast ordrenummer" maxlength="17" value="<?php echo $storeCode; ?>" required autofocus>
                  <p class="text-center calculatedButton"><input type="submit" class="button callSpin" value="Gem medlemskab"></p>
                </form>
              </div>
            </div>
          </div>
