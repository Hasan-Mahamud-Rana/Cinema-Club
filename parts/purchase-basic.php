	...
	<div class="createProfile-panel">
		<div class="row">
			<div class="medium-11 medium-centered large-9 large-centered createProfile-form-panel">
				...
				<form action='<?php echo site_url(); ?>/purchase/basket' method="POST" data-parsley-validate>
					<div class="row column purchasePackage-form">
						...
						<div class="large-12 text-center bptextForMobile">
							<h4>Vil du også købe Premium-medlemskaber,<br/>inden du går til betaling, kan du gøre det her.</h4>
							<p>Premium-medlemskabet består af 10 filmkuponer, og du kan købe så mange, du vil.</p>
						</div>
						<div class="large-12 text-center subHead">
