...
$singleMembership = cancel_flex_membership($customerid, $membershiporderlineid);
?>
		...
		<div class="row">
			<div class="small-12 medium-8 medium-centered large-8 large-centered flexCancel-panel columns">
				...
				<section class="entry-content" itemprop="articleBody"><br/>
					<?php
					the_content();
					echo '<p class="lgindbtn text-center calculatedButton callSpin"><a class="button" href="'.site_url().'">TILBAGE TIL FORSIDEN</a></p>';
					?>
				</section>
			</div>
		</div>
