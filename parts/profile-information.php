...
<?php } ?>
      ...
      <form action='<?php echo site_url(); ?>/profile/save' method="POST" data-parsley-validate data-parsley-focus="none">
        <div class="row column createProfile-form">
          ...
          <?php } ?>
          <?php if(!empty($tempErrorPhone) || !empty($tempErrorEmail)) { ?>
          ...
          <div class="row">
            <div class="small-12 medium-10 medium-centered large-9 large-centered columns pi">
              ...
              <div class="large-12 columns">
                <input type="text" placeholder="Angiv en adgangskode" name='password'>
              </div>
              <div class="large-12 columns">
                <input type="text" placeholder="Gentag adgangskode" name='password_confirmation'>
              </div>
              <?php } ?>
              <?php if ( $receivegeneralnewsletter != true ) { ?>
              <div class="large-12 columns cp2" style="margin: 0; display: none;">
              ...
              <div class="large-12 columns fbblock">
                <p>Du er logget ind med Facebook. Hvis du vil ændre din adgangskode, skal du afbryde forbindelsen til Facebook.</p>
                <p class="lpss text-center"><a href="<?php echo site_url(); ?>/profile/save/?remove_fb_login=1">Afbryd forbindelsen til Facebook</a></p>
              </div>
              <?php } ?>

              <div class="large-12 columns" style="display: none;">
                <input id="profileInformation" type="checkbox" name='profileInformation' value="1" checked>
              </div>
              <div class="large-12 columns text-center calculatedButton">
              <?php  if ( $facebook_login != true ) {?>
                <a class="fblgbtn button" data-open="confirmation">Log ind med Facebook</a>
              <?php } ?>
...
<div class="reveal" id="confirmation" data-reveal>
  <p class="overlayHeading">GÅ TIL LOGIN?</p>
  <p class="overlayText" style="color: #000;">Du er allerede oprettet som bruger hos os uden at have tilknyttet Facebook til dit login. Log venligst ind med din email og adgangskode for at tilknytte Facebook til dit login</p>
  <p class="text-center ovrLayBtn"><a class="fblgbtn button callSpin" href="<?php echo FB_HOST; ?>">GÅ TIL LOGIN</a></p>
